...
import { Category, Item } from "@/types/DB";
...
export default function CategoryItemsModal({ category, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
      <div className="bg-slate-900 w-full max-w-4xl max-h-[80vh] rounded-lg shadow-xl flex flex-col">
        {/* Header */}
        ...
        <div className="px-6 py-4 border-b border-slate-700">
          <input
            ...
            className="w-full px-4 py-3 rounded text-lg bg-slate-700 text-white border border-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
              ...
              <thead className="sticky top-0 bg-slate-800">
                <tr className="text-slate-300 border-b border-slate-700">
                  ...
                  <th className="px-3 py-3">
                    {t("CategoriesPage.items.actions")}
                  </th>
                </tr>
              </thead>
              ...
              <tbody>
                {filteredItems.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3 text-slate-300">{item.barcode}</td>
